...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{A short description of danger-simplecov_json.}
  spec.summary       = %q{A longer description of danger-simplecov_json.}
  spec.homepage      = 'https://github.com/Marcelo Fabri/danger-simplecov_json'
  spec.license       = 'MIT'
